  ...
  return (
    ...
    >
      <div className="flex justify-between items-start">
        <h3 className="text-dt-lg font-bold text-dt-foreground">{title}</h3>
        <span className="text-dt-2xl font-bold text-dt-accent">{count}</span>
      </div>
      <p className="text-dt-sm text-dt-subtle mt-2">{description}</p>
    </Link>
  );
};
