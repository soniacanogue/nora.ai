  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-2">
        <h3 className="text-sm font-bold text-dt-foreground uppercase tracking-wider group-hover:text-dt-accent transition-colors">{title}</h3>
        <span className="text-2xl font-bold text-dt-accent font-mono group-hover:scale-110 transition-transform drop-shadow-[0_0_5px_rgba(138,43,226,0.5)]">{count}</span>
      </div>
